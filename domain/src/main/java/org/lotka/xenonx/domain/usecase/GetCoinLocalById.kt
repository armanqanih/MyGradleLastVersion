...
class GetCoinsLocalByIdUseCase @Inject constructor(
    private val coinRepository: CoinRepository
) {
    suspend operator fun invoke(coinId: String): Flow<CoinDetailModel?> {
        return coinRepository.getCoinDetailByIdInDataBase(coinId)
    }
}